...
from foreshadow.preparer.steps. import GenericIntent
from foreshadow.smart.intents.registry import registry_eval
...
def _ser_params(trans):
    ...
    """
    from foreshadow.concrete import no_serialize_params
